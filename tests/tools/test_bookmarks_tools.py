...
class FakeZohoClient:
    ...
    async def list_bookmarks(self, limit=20, after=0):
        self.list_bookmarks_calls.append({"limit": limit, "after": after})
...
async def test_list_bookmarks_delegates_to_client():
    ...
    assert client.list_bookmarks_calls == [{"limit": 5, "after": 10}]
...
async def test_list_bookmarks_defaults_limit_and_after():
    ...
    assert client.list_bookmarks_calls == [{"limit": 20, "after": 0}]
